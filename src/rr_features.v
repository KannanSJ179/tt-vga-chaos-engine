    ...
    always @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            if (r_peak_rise) begin
                ...
                // tick_count[14:9] gives a 6-bit interval value (0–63).
                // tick_count[15] overflow → saturate at 63 (max ~3.2 s interval).
                // Using 6-bit slice avoids WIDTHTRUNC/WIDTHEXPAND lint warnings.
                rr_interval   <= tick_count[15] ? 6'd63 : tick_count[14:9];
                rr_delta      <= (tick_count[14:9] > rr_prev)
                                 ? tick_count[14:9] - rr_prev
                                 : rr_prev - tick_count[14:9];
                rr_prev       <= tick_count[15] ? 6'd63 : tick_count[14:9];
                rr_valid      <= 1'b1;
                tick_count    <= 16'd0;
